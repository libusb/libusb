if "%APPVEYOR_REPO_TAG%" == "true" (
    conan create %APPVEYOR_BUILD_FOLDER% "%APPVEYOR_PROJECT_NAME%/%APPVEYOR_REPO_TAG_NAME:v=%@barco/healthcare build_type=%configuration% -s compiler="Visual Studio" -s compiler.version=%MSVC_VERSION%
