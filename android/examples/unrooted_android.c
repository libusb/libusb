...
/*
 * LibUsb can only be included to Android Projects Source over NDK up to now. (CMake is not supported at the moment)
 * (Android Studio)
 * Clone the last LibUsb GitHub Repo to your Android Project and include the Android.mk file to your build.gradle.
 */
