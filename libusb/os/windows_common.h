...
struct winusb_device_priv {
	...
	volatile LONG64 string_backoff_expiry; // skip string descriptor requests until this
	                                       // GetTickCount64() time, set on request timeout,
	                                       // accessed with interlocked operations only
