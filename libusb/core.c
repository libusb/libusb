 ...
 * Note: On macOS data is an ASCII decimal representation of a uint64_t
 *
 * \param dev a device
 * \param data output location for the returned platform id string. Set to NULL
 * on failure. Must later be freed with free().
